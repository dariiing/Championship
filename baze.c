...
int main(int argc, char* argv[]) {
   ...
   sql = "INSERT INTO ACCOUNTS (USERNAME, NAME,ADMIN,STRONG, WEAK, ID, EMAIL) "  \
         "VALUES ('daria', 'Daria', 1,'tennis','football', 1, 'dariae9@yahoo.com'); " \
         "INSERT INTO ACCOUNTS (USERNAME, NAME,ADMIN,STRONG, WEAK, ID, EMAIL) "  \
         "VALUES ('paul', 'Paul', 0,'tennis','chess', 2, 'dariae9@yahoo.com'); " \
         "INSERT INTO ACCOUNTS (USERNAME, NAME, ADMIN, STRONG, WEAK, ID, EMAIL) "  \
         "VALUES ('andreea', 'Andreea', 1,'football','tennis', 3, 'dariae9@yahoo.com'); " \
         "INSERT INTO ACCOUNTS (USERNAME, NAME, ADMIN, STRONG, WEAK, ID, EMAIL) "  \
         "VALUES ('stefan', 'Stefan', 0,'chess', 'football', 4, 'dariae9@yahoo.com'); " \
         "INSERT INTO ACCOUNTS (USERNAME, NAME,ADMIN,STRONG, WEAK, ID, EMAIL) "  \
         "VALUES ('mihai', 'Mihai', 1,'tennis','chess' ,5, 'dariae9@yahoo.com'); " \
